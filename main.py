...
# 2. МУРУНКУ ТОКЕН ЖАНА ЖАҢЫ API KEY
API_TOKEN = "8214859958:AAHz1JKP_ylFjmjOUK42UMgA4xE_hR0gMq8"
AI_KEY = "AIzaSyASdsrc7WPltcYWA-YtKeqBR_dSY-DIZGw"
...
def send_welcome(message):
    bot.reply_to(message, "Салам, Арген! 😊 Мен Анисамын. Жаңы ачкыч менен ишке кирдим, эми баарлаша берсек болот!")

@bot.message_handler(func=lambda message: True)
def handle_message(message):
    user_text = message.text
    
    # Анисанын ролун түзүү
    try:
        prompt = (
